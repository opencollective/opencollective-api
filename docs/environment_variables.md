...
| TRANSFERWISE_BLOCKED_RECIPIENT_TYPES_BUSINESS | .transferwise.recipientTypesBlockedForBusinessProfiles | TransferWise blocked recipient types for business profiles                         |
