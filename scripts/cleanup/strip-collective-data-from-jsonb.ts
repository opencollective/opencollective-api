...
const COLLECTIVE_SNAPSHOT_KEYS = [
  'collective',
  'host',
  'fromCollective',
  'toCollective',
...
const slimSpamReportData = (data: unknown): Record<string, unknown> | null => {
...
const jsonbSize = (data: unknown): number => Buffer.byteLength(JSON.stringify(data ?? null), 'utf8');
...
const runStripCollectiveDataFromJsonb = async (
  db: Sequelize,
