...
nock('https://api.mailgun.net:443')
  .get('/v3/lists')
  .reply(200, { 'items':[],'total_count':11 }, { server: 'nginx',
...
nock('https://api.mailgun.net:443')
  .post('/v3/lists', 'address=backers%40testcollective.opencollective.com&description=Mailing%20list%20for%20all%20the%20backers%20of%20Test%20Collective')
  .reply(200, { 'list':{ 'access_level':'readonly','address':'backers@testcollective.opencollective.com','created_at':'Fri, 29 Jul 2016 14:40:32 -0000','description':'Mailing list for all the backers of Test Collective','members_count':0,'name':'' },'message':'Mailing list has been created' }, { server: 'nginx',
  date: 'Fri, 29 Jul 2016 14:40:32 GMT',
  'content-type': 'application/json',
  'content-length': '323',
  connection: 'close',
...
nock('https://api.mailgun.net:443')
  ...
  .reply(200, { 'address':'backers@testcollective.opencollective.com','message':'Mailing list has been removed' }, { server: 'nginx',
...
nock('https://api.mailgun.net:443')
  .post('/v3/lists', 'address=backers%40testcollective.opencollective.com&description=Mailing%20list%20for%20all%20the%20backers%20of%20Test%20Collective')
  .reply(200, { 'list':{ 'access_level':'readonly','address':'backers@testcollective.opencollective.com','created_at':'Fri, 29 Jul 2016 14:40:33 -0000','description':'Mailing list for all the backers of Test Collective','members_count':0,'name':'' },'message':'Mailing list has been created' }, { server: 'nginx',
  date: 'Fri, 29 Jul 2016 14:40:33 GMT',
  'content-type': 'application/json',
  'content-length': '323',
  connection: 'close',
...
nock('https://api.mailgun.net:443')
  .post('/v3/lists', 'address=sponsors%40testcollective.opencollective.com&description=Mailing%20list%20for%20all%20the%20sponsors%20of%20Test%20Collective')
  .reply(200, { 'list':{ 'access_level':'readonly','address':'sponsors@testcollective.opencollective.com','created_at':'Fri, 29 Jul 2016 14:40:33 -0000','description':'Mailing list for all the sponsors of Test Collective','members_count':0,'name':'' },'message':'Mailing list has been created' }, { server: 'nginx',
  date: 'Fri, 29 Jul 2016 14:40:33 GMT',
  'content-type': 'application/json',
  'content-length': '325',
  connection: 'close',
...
nock('https://api.mailgun.net:443')
  ...
  .reply(200, { 'address':'sponsors@testcollective.opencollective.com','message':'Mailing list has been removed' }, { server: 'nginx',
