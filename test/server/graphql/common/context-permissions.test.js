...
describe('server/graphql/common/context-permissions', () => {
  ...
  it('returns false by default', () => {
    expect(getContextPermission(req, PERMISSION_TYPE.SEE_PAYOUT_METHOD_DETAILS, 1)).to.be.false;
  });

  it('can allow permissions for individual entities', () => {
    allowContextPermission(req, PERMISSION_TYPE.SEE_PAYOUT_METHOD_DETAILS, 1);
    expect(getContextPermission(req, PERMISSION_TYPE.SEE_PAYOUT_METHOD_DETAILS, 1)).to.be.true;
    expect(getContextPermission(req, PERMISSION_TYPE.SEE_PAYOUT_METHOD_DETAILS, 2)).to.be.false;
  });
