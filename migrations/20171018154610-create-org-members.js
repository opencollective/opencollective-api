      ...
      return sequelize.query(`
        ...
        .then(users => {
          ...
          if (users.length === 1) {
            ...
            return insert(sequelize, 'Collectives', _.pick(userCollectiveInfo, _.identity))
...
module.exports = {
  up: (queryInterface, DataTypes) => {
      ...
      return updateOrgMembers(queryInterface.sequelize)
      .then(() => {
        ...
        console.log('>>> ', orgsFoundWithoutMember.length, 'orgs found without member')
      })
  },
