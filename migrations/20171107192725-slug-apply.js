...
const updateApplyHosts = (sequelize) => {
  ...
  .each(collective => {
    ...
    console.log('\n>>> Changing collective id', collective.id, 'from', originalSlug, 'to', newSlug);
    console.log('>>> Changing host collective id', collective.HostCollectiveId, 'from', collective.hostSlug, 'to', originalSlug);
...
module.exports = {
  up: (queryInterface, DataTypes) => {
      ...
      return updateApplyHosts(queryInterface.sequelize)
      .then(() => {
