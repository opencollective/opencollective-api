...
module.exports = {
  up: async queryInterface => {
    await queryInterface.sequelize.query(`
      ...
      ADD VALUE IF NOT EXISTS 'CONTRIBUTION_DEBT' AFTER 'CONTRIBUTION'
    `);
  },
  ...
  down: async queryInterface => {
    ...
    await queryInterface.sequelize.query(`
      CREATE TYPE "enum_Transactions_kind" as enum ('ADDED_FUNDS', 'BALANCE_TRANSFER', 'CONTRIBUTION', 'EXPENSE', 'HOST_FEE', 'HOST_FEE_SHARE', 'HOST_FEE_SHARE_DEBT', 'PAYMENT_PROCESSOR_COVER', 'PAYMENT_PROCESSOR_FEE', 'PLATFORM_FEE', 'PLATFORM_TIP', 'PLATFORM_TIP_DEBT', 'PREPAID_PAYMENT_METHOD')
    `);
