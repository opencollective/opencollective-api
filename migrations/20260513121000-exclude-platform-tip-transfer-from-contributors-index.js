...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.sequelize.query(`
      ...
      WHERE type = 'CREDIT' AND kind NOT IN ('HOST_FEE', 'HOST_FEE_SHARE', 'HOST_FEE_SHARE_DEBT', 'PLATFORM_TIP_DEBT', 'PLATFORM_TIP_TRANSFER') AND "deletedAt" IS NULL AND "RefundTransactionId" IS NULL;
    `);
  },
