...
module.exports = {
  async up(queryInterface) {
    ...
    // Same shape as 20240418095842-v3-balance-compatible-materialized-view.js,
    // with APPLICATION_FEE slotted at priority 3 (immediately after PLATFORM_TIP).
        ...
        SELECT
          ...
          RANK() OVER (
            ...
            CASE
              ...
              WHEN "kind" IN ('APPLICATION_FEE') THEN 3
              WHEN "kind" IN ('PLATFORM_TIP_DEBT') THEN 4
              WHEN "kind" IN ('PAYMENT_PROCESSOR_FEE') THEN 5
              WHEN "kind" IN ('PAYMENT_PROCESSOR_COVER') THEN 6
              WHEN "kind" IN ('HOST_FEE') THEN 7
              WHEN "kind" IN ('HOST_FEE_SHARE') THEN 8
              WHEN "kind" IN ('HOST_FEE_SHARE_DEBT') THEN 9
                ELSE 10
              END
            ASC,
            CASE
