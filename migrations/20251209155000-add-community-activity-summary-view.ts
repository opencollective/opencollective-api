...
module.exports = {
  async up(queryInterface) {
    await queryInterface.sequelize.query(
      `
        CREATE INDEX CONCURRENTLY IF NOT EXISTS "activities__host_type_from_collective_id"
        ON "Activities" ("HostCollectiveId", "type", "FromCollectiveId")
        ...
        WITH
          relevant_activities AS (
            ...
            SELECT
              ...
              NULL AS "type", m."createdAt", m.role AS "relations"
            FROM
              "Members" m
  ...
  async down(queryInterface) {
    await queryInterface.sequelize.query(`DROP INDEX IF EXISTS "activities__host_type_from_collective_id";`);
    await queryInterface.sequelize.query(`DROP MATERIALIZED VIEW IF EXISTS "CommunityActivitySummary";`);
  },
};
