    ...
    while (hasMore) {
      ...
      if (transactionsToAdd.length) {
        try {
          ...
          // This may happen because of a concurrency issue where a webhook inserted the
          // transaction we're looking at. Let's refresh the list of synced transactions and try again.
