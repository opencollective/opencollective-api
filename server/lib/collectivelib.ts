...
export function validateSettings(settings: any): string | boolean {
   ...
   */
  if ((settings.customEmailMessage?.thankYou && stripHTML(settings.customEmailMessage.thankYou).length > 500) || (settings.customEmailMessage && stripHTML(settings.customEmailMessage).length > 500)) {
