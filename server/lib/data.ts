import { differenceBy, flatten, get, isEqual, isNil, isPlainObject, isUndefined, merge, omit, pick } from 'lodash';
...
export const getDiffBetweenInstances = <T extends Model>(
  newData: object | T,
