...
export enum PERMISSION_TYPE {
  ...
  /** Private info: legal name, email, etc. (excludes location) */
  SEE_ACCOUNT_PRIVATE_PROFILE_INFO = 'SEE_ACCOUNT_PRIVATE_PROFILE_INFO',
  /** Private location/address info */
  SEE_ACCOUNT_PRIVATE_LOCATION = 'SEE_ACCOUNT_PRIVATE_LOCATION',
  SEE_EXPENSE_DRAFT_PRIVATE_DETAILS = 'SEE_EXPENSE_DRAFT_PRIVATE_DETAILS',
  SEE_SUBSCRIPTION_PRIVATE_DETAILS = 'SEE_SUBSCRIPTION_PRIVATE_DETAILS',
  SEE_PAYMENT_METHOD_DETAILS = 'SEE_PAYMENT_METHOD_DETAILS',
}
