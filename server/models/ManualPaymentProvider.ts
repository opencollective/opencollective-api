 ...
 */
const sanitizeManualPaymentProviderReferenceTemplate = (value: string): string | null => {
...
class ManualPaymentProvider extends ModelWithPublicId<
  EntityShortIdPrefix.ManualPaymentProvider,
  InferAttributes<ManualPaymentProvider>,
  InferCreationAttributes<ManualPaymentProvider>
> {
  public static readonly nanoIdPrefix = EntityShortIdPrefix.ManualPaymentProvider;
