 ...
 */
class ExpenseItem extends ModelWithPublicId<InferAttributes<ExpenseItem>, InferCreationAttributes<ExpenseItem>> {
  public static readonly nanoIdPrefix = 'expi' as const;
