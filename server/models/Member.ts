...
class Member extends ModelWithPublicId<
  EntityShortIdPrefix.Member,
  InferAttributes<Member, { omit: 'info' }>,
  InferCreationAttributes<Member>
> {
  public static readonly nanoIdPrefix = EntityShortIdPrefix.Member;
