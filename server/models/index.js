...
export function setupModels() {
  ...
  m['SuspendedAsset'] = SuspendedAsset;
  m['Tier'] = Tier;
  ...
  // Personal tokens
  m.PersonalToken.belongsTo(m.User, { foreignKey: 'UserId', as: 'user' });
  m.PersonalToken.belongsTo(m.Collective, { foreignKey: 'CollectiveId', as: 'collective' });
